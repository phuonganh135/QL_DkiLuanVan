...
module.exports.getSinhVienDangKiList = function (dt_ma ,callback) {
    pool.query('SELECT * FROM sinhvien_dk_detai as svdkdt , sinhvien as sv WHERE svdkdt.dt_ma = dt.dt_ma and svdkdt.sv_ma = sv.sv_ma and svdkdt.ttdk_ma=\'yc\' and svdkdt.dt_ma=$1', [dt_ma], (error, results) => {
        callback(error, results.rows);
    });
};
